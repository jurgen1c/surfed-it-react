...
export function get(base, path, session) {
  return send({
    method: 'GET', path, session, base,
  });
}

export function del(base, path, data, session) {
  return send({
    method: 'DELETE', path, data, session, base,
  });
}

export function post(base, path, data, session) {
  return send({
    method: 'POST', path, data, session, base,
  });
}

export function put(base, path, data, session) {
  return send({
    method: 'PUT', path, data, session, base,
  });
}
